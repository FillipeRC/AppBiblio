...
public class UICadastroUsuario extends javax.swing.JFrame {
    ...
    public static void setInstance(UICadastroUsuario aux){
        uicu = aux;
    }
    
    public static UICadastroUsuario getInstance(){
        return uicu;
    }
    ...
    private void initComponents() {
        ...
        painel_lista_cad_userLayout.setHorizontalGroup(
            ...
            .addGroup(painel_lista_cad_userLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(painel_lista_cad_userLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
